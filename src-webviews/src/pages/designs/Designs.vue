...
<template>
    <div class="stack background">
        ...
        <div class="split space-between">
            ...
            <Button color="green" @click="doSomething">Submit</Button>
            ...
            <Button color="green" :raise="false" :flatten="true" @click="doSomething">Submit</Button>
        ...
        <div class="split space-between">
            <Button color="green" @click="doSomething" class="fab">
                <Icon class="green--text" :size="16" icon="icon-chevron-left" />
            </Button>
            <Button color="green" @click="doSomething" class="fab">
                <Icon class="green--text" :size="16" icon="icon-chevron-right" />
            </Button>
