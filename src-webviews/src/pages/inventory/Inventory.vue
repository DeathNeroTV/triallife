        ...
        if (!('alt' in window)) {
            ...
            this.updateInventory([
                ...
                },
                {
                    ...
                    data: {
                        weight: 1,
                        reallyLongText: 'kl;fdj;klsajfkl;dasjf;klsjfkl;sajl;kfjs;klfewj;klfwjkal;fjwe;klfajwkl;fwejal;kfweaj',
                    },
                },
                {
                    name: `Box`,
...
.weight-holder {
    background: linear-gradient(90deg, rgba(255, 255, 255, 0) 0%, rgba(0, 0, 0, 0.4) 30%, rgba(0, 0, 0, 0.4) 60%, rgba(255, 255, 255, 0) 100%);
    width: 50%;
    text-align: center;
    padding-top: 5px;
    padding-bottom: 5px;
