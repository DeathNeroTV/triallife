...
function writeServerImports(plugins) {
    ...
    const importPath = sanitizePath(path.join(process.cwd(), 'resources/core/plugins/triallife/server/imports.js'));
...
function writeClientImports(plugins) {
    ...
    const importPath = sanitizePath(path.join(process.cwd(), 'resources/core/plugins/triallife/client/imports.js'));
    fs.outputFileSync(importPath, content + '\n');
}
