...
const DEFAULT_DATABASE_NAME = 'triallife';
const DEFAULT_MONGO_URL = `mongodb://USERNAME:PASSWORD@0.0.0.0:27017`;
const DEFAULT_COLLECTIONS: string[] = [Collections.Accounts, Collections.Characters, Collections.Options, Collections.Interiors, Collections.Vehicles, Collections.Storage];
...
export default {
    ...
    throwConnectionError: () => {
        ...
        alt.logWarning(`Error Connecting to MongoDB Database. Check your MONGO_URL in triallifeConfig.json`);
