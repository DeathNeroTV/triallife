...
class InternalFunctions {
    ...
    static enter(colshape: InteractionShape, entity: alt.Entity) {
        ...
        if (colshape.interaction.debug) {
            ...
            console.log(`--- ColShape Interaction ---`);
            console.log(colshape.interaction);
            triallife.player.emit.soundFrontend(entity, 'Hack_Success', 'DLC_HEIST_BIOLAB_PREP_HACKING_SOUNDS');
        }
    ...
    static leave(colshape: InteractionShape, entity: alt.Entity) {
        ...
        if (colshape.interaction.debug) {
            ...
            console.log(`--- ColShape Interaction ---`);
            console.log(colshape.interaction);
            triallife.player.emit.soundFrontend(entity, 'Hack_Failed', 'DLC_HEIST_BIOLAB_PREP_HACKING_SOUNDS');
        }
    ...
    static trigger(player: alt.Player): void {
        ...
        if (dist >= DEFAULT_CONFIG.MAX_INTERACTION_DISTANCE) {
            triallife.player.emit.notification(player, LocaleController.get(LOCALE_KEYS.INTERACTION_TOO_FAR_AWAY));
            return;
        }
