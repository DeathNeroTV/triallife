...
type setEquipmentTypes = `${PlayerInjectionNames.EQUIPMENT_UPDATE_START}` | `${PlayerInjectionNames.EQUIPMENT_AFTER_DEFAULTS}` | `${PlayerInjectionNames.EQUIPMENT_UPDATE_END}`;

type characterSelectTypes = `${PlayerInjectionNames.BEFORE_CHARACTER_SELECT}` | `${PlayerInjectionNames.AFTER_CHARACTER_SELECT}`;
