 ...
 */
async function justEquip(player: CharacterInventory | Pick<alt.Player, 'data'>, item: Item<{ slot: EQUIPMENT_TYPE }>): Promise<boolean> {
 ...
 */
async function unequip(player: CharacterInventory | Pick<alt.Player, 'data'>, slot: number): Promise<Item<{ slot: EQUIPMENT_TYPE }> | false> {
