...
export default {
    ...
    // Item
    [LOCALE_KEYS.ITEM_NOT_EQUIPPED]: `Der Platz ist leer.`,
    [LOCALE_KEYS.ITEM_DOES_NOT_EXIST]: `_%_ gibt es nicht.`,
    [LOCALE_KEYS.ITEM_WAS_ADDED_INVENTORY]: `_%_ erhalten.`,
    [LOCALE_KEYS.ITEM_WAS_ADDED_EQUIPMENT]: `_%_ angelegt.`,
    [LOCALE_KEYS.ITEM_WAS_ADDED_TOOLBAR]: `_%_ zugewiesen.`,
    [LOCALE_KEYS.ITEM_WAS_DESTROYED_ON_DROP]: `_%_ zerstört.`,
    // Job
    ...
    [LOCALE_KEYS.WEBVIEW_INVENTORY]: {
        ITEM_SLOTS: ['Hat', 'Mask', 'Shirt', 'Pants', 'Feet', 'Glasses', 'Ears', 'Bag', 'Armour', 'Watches', 'Bracelets', 'Accessory'],
        LABEL_SPLIT: 'split',
        LABEL_CANCEL: 'cancel',
