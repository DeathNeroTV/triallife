            ...
            <div class="wrapper stack">
                ...
                <Module name="Konto hinzufügen" class="mb-4">
                    <Module class="mb-4" name="Allgemeines">
                        ...
                        Die Geschäftsbeziehung zwischen dem Kunden und der {{ name }} ist
                        durch die Besonderheiten des Bankgeschäfts und ein besonderes Vertrauensverhältnis geprägt. Der Kunde kann sich darauf verlassen, dass
                        die {{ name }} seine Aufträge mit der Sorgfalt eines ordentlichen Kaufmanns ausführt und das Bankgeheimnis wahrt.<br><br>
                        ...
                        Vereinbarungen diese Allgemeinen Geschäftsbedingungen (AGB). Für
                        einzelne Geschäftszweige gelten ergänzend oder abweichend besondere
                        Bedingungen, z. B. für die Bereiche des Zahlungsverkehrs, des Sparverkehrs und der Wertpapiergeschäfte; diese werden beim Vertragsabschluss (etwa bei der Kontoeröffnung) oder bei der Erteilung von Aufträgen mit dem Kunden vereinbart.<br><br>
                        ...
                        Änderungen dieser Allgemeinen Geschäftsbedingungen und der besonderen Bedingungen werden dem Kunden spätestens zwei Monate vor
                        dem vorgeschlagenen Zeitpunkt ihres Wirksamwerdens in Textform
                        angeboten. Hat der Kunde mit der {{ name }} im Rahmen der Geschäftsbeziehung einen elektronischen Kommunikationsweg vereinbart (z. B.
                        das Elektronische Postfach), können die Änderungen auch auf diesem
                        Wege angeboten werden.<br><br>
                        <span :class="color + '--text text-md-h6'">(2) Annahme durch den Kunden</span><br>
                        Die von der {{ name }} angebotenen Änderungen werden nur wirksam,
                        wenn der Kunde diese annimmt, gegebenenfalls im Wege der nachfolgend geregelten Zustimmungsfiktion.<br><br>
                        ...
                        a) das Änderungsangebot der {{ name }} erfolgt, um die Übereinstimmung der vertraglichen Bestimmungen mit einer veränderten Rechtslage
                        wiederherzustellen, weil eine Bestimmung der Allgemeinen Geschäftsbedingungen oder der besonderen Bedingungen
                        <br>– aufgrund einer Änderung von Gesetzen, einschließlich unmittelbar geltender Rechtsvorschriften der Europäischen Union, nicht mehr der
                        Rechtslage entspricht oder
                        <br>– durch eine rechtskräftige gerichtliche Entscheidung, auch durch ein
                        Gericht erster Instanz, unwirksam wird oder nicht mehr verwendet
                        werden darf oder<br>
                        – aufgrund einer verbindlichen Verfügung einer für die {{ name }} zuständigen nationalen oder internationalen Behörde (z. B. der Bundesanstalt
                        für Finanzdienstleistungsaufsicht oder der Europäischen Zentralbank)
                        nicht mehr mit den aufsichtsrechtlichen Verpflichtungen der {{ name }}
                        in Einklang zu bringen ist
                        und<br>
                        b) der Kunde das Änderungsangebot der {{ name }} nicht vor dem vorgeschlagenen Zeitpunkt des Wirksamwerdens der Änderungen abgelehnt
                        hat.
                        Die {{ name }} wird den Kunden im Änderungsangebot auf die Folgen
                        seines Schweigens hinweisen.<br><br>
                        ...
                        – bei Änderungen der Nummern 2 und 17 Abs. 6 der Allgemeinen
                        Geschäftsbedingungen und der entsprechenden Regelungen in den
                        besonderen Bedingungen oder<br>
                        – bei Änderungen, die die Hauptleistungspflichten des Vertrages und die
                        Entgelte für Hauptleistungen betreffen, oder<br>
                        – bei Änderungen von Entgelten, die auf eine über das vereinbarte Entgelt
                        für die Hauptleistung hinausgehende Zahlung des Verbrauchers gerichtet sind, oder<br>
                        ...
                        Gegenleistung erheblich zugunsten der {{ name }} verschieben würden.
                        In diesen Fällen wird die {{ name }} die Zustimmung des Kunden zu den
                        Änderungen auf andere Weise einholen.<br><br>
                        <span :class="color + '--text text-md-h6'">(5) Kündigungsrecht des Kunden bei der Zustimmungsfiktion</span><br>
                        Macht die {{ name }} von der Zustimmungsfiktion Gebrauch, kann der
                        Kunde den von der Änderung betroffenen Vertrag vor dem vorgeschlagenen Zeitpunkt des Wirksamwerdens der Änderungen auch fristlos und
                        kostenfrei kündigen.
                        Auf dieses Kündigungsrecht wird die {{ name }} den Kunden in ihrem
                        Änderungsangebot besonders hinweisen.<br>
                    </Module> 
                    <div class="split space-between mb-4">   
                        <Input label="Vorname" class="fill-full-width mr-5" :placeholder="charName.split('_')[0]" :number-only="false" :stack="false" :rules="[]" :readonly="true"></Input> 
                        <Input label="Nachname" class="fill-full-width mr-5" :placeholder="charName.split('_')[1]" :number-only="false" :stack="false" :rules="[]" :readonly="true"></Input>    
                        <RangeInput 
