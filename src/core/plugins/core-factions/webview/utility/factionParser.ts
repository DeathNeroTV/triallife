...
export class FactionParser {
     ...
     */
    static getFactionMembers(faction: Faction, orderByRank = true): Array<{ id?: string; weight?: number } & FactionCharacter> {
     ...
     * @memberof FactionParser
     */
    static getValidPermissions(actingUserRank: FactionRank, againstUserRank: FactionRank, hasOwnership = false): Partial<RankPermissions> {
