...
export default defineComponent({
    ...
    methods: {
        ...
        updateComponent(index: number, dataName: string, value: number, isIncrement = false) {
            ...
            const maxValue = dataName === 'drawables' ? pages[this.pageIndex].maxDrawables[index] : pages[this.pageIndex].maxTextures[index];
        ...
        purchaseComponent() {
            ...
            alt.emit(`${ComponentName}:Purchase`, this.storeData.uid, this.pageIndex, componentData, this.name, this.desc);
            this.togglePurchaseInterface(false);
        },
        setData(data) {
            this.storeData = data;
