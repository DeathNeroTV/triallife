...
class BarbershopView implements ViewModel {
    ...
    static setupCamera() {
        ...
        native.pointCamAtCoord(camera, alt.Player.local.pos.x, alt.Player.local.pos.y, alt.Player.local.pos.z + Z_POS_ADD);
    ...
    static async ready() {
        ...
        triallifeClient.webview.emit(BarbershopEvents.WebViewEvents.SET_DATA, currentData);
