<template>
    <div class="wrapper stack" v-if="!processing">
        <div class="subtitle-2 grey--text mb-2 mt-2">Persönliche Daten</div>
        ...
        <div class="subtitle-2 grey--text mb-2 mt-6">Geburtsdatum</div>        
        <div class="split split-full center mt-4">
            <Input
        ...
        <div class="subtitle-2 grey--text mb-2 mt-6">Geschlechtsmerkmal</div>
        ...
        <div class="split split-full center mt-8 pb-4" v-if="!isAllValid() && valid.first && valid.last">
            <Button color="orange" :raise="true" @click="verifyName">Namen prüfen</Button>
        </div>
        <div class="split split-full space-between center mt-8 pb-4" v-if="isAllValid() && valid?.first && valid.last">
            <Button class="mr-2 fill-full-width" color="orange" :raise="true" @click="verifyName">Namen prüfen</Button>
            <Button class="ml-2 fill-full-width" color="green" :raise="true" @click="save">Fertig</Button>
        </div>
    </div>
</template>
