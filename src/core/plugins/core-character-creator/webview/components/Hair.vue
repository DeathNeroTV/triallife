    ...
    <div class="wrapper stack">
        <Module :name="getLocale('LABEL_HAIRSTYLE')" class="mb-4">
            ...
            <div class="split split-full center">
                <Button color="green" @click="decValueWrap('hair', 0, getHairCount(), 1)">
                ...
                />
                <Button color="green" @click="incValueWrap('hair', 0, getHairCount(), 1)">
            ...
            <div class="split split-full center">
                <Button color="green" @click="$emit('dec-parameter', 'hairColor1', 0, getColourCount(), 1)">
                    <Icon :size="14" icon="icon-chevron-left"></Icon>
                </Button>
                <RangeInput
                    :minIndex="0"
                    ...
                    class="pl-3 pr-3 fill-full-width"
                />
                <Button color="green" @click="$emit('inc-parameter', 'hairColor1', 0, getColourCount(), 1)">
                    <Icon :size="14" icon="icon-chevron-right"></Icon>
                </Button>
            </div>
            <!-- Highlights -->
            ...
            <div class="split split-full center">
                <Button color="green" @click="$emit('dec-parameter', 'hairColor2', 0, getColourCount(), 1)">
                    <Icon :size="14" icon="icon-chevron-left"></Icon>
                </Button>
                <RangeInput
                    :minIndex="0"
                    ...
                    class="pl-3 pr-3 fill-full-width"
                />
                <Button color="green" @click="$emit('inc-parameter', 'hairColor2', 0, getColourCount(), 1)">
                    <Icon :size="14" icon="icon-chevron-right"></Icon>
                </Button>
            </div>
        </Module>
        ...
        <Module :name="getLocale('LABEL_EYEBROWS')" class="mb-4">
            ...
            <div class="split split-full center">
                <Button color="green" @click="$emit('dec-parameter', 'eyebrows', 0, getEyebrowsCount(), 1)">
                    <Icon :size="14" icon="icon-chevron-left"></Icon>
                </Button>
                <RangeInput
                    :minIndex="0"
                    ...
                    class="pl-3 pr-3 fill-full-width"
                />
                <Button color="green" @click="$emit('inc-parameter', 'eyebrows', 0, getEyebrowsCount(), 1)">
                    <Icon :size="14" icon="icon-chevron-right"></Icon>
                </Button>
            </div>
            <!-- Eyebrow Colour -->
            ...
            <div class="split split-full center">
                <Button color="green" @click="$emit('dec-parameter', 'eyebrowsColor1', 0, getColourCount(), 1)">
                    <Icon :size="14" icon="icon-chevron-left"></Icon>
                </Button>
                <RangeInput
                    :minIndex="0"
                    ...
                    class="pl-3 pr-3 fill-full-width"
                />
                <Button color="green" @click="$emit('inc-parameter', 'eyebrowsColor1', 0, getColourCount(), 1)">
                    <Icon :size="14" icon="icon-chevron-right"></Icon>
                </Button>
            </div>
            <!-- Eyebrow Opacity -->
            ...
            <div class="split split-full center">
                <Button color="green" @click="$emit('dec-parameter', 'eyebrowsOpacity', 0, 1, 0.1)">
                    <Icon :size="14" icon="icon-chevron-left"></Icon>
                </Button>
                <RangeInput
                    :minIndex="0"
                    ...
                    class="pl-3 pr-3 fill-full-width"
                />
                <Button color="green" @click="$emit('inc-parameter', 'eyebrowsOpacity', 0, 1, 0.1)">
                    <Icon :size="14" icon="icon-chevron-right"></Icon>
                </Button>
            </div>
        </Module>
        ...
        <Module :name="getLocale('LABEL_FACIAL_HAIR')" class="mb-4" v-if="data.sex === 1">
            ...
            <div class="split split-full center">
                <Button color="green" @click="$emit('dec-parameter', 'facialHair', 0, getFacialCount(), 1)">
                    <Icon :size="14" icon="icon-chevron-left"></Icon>
                </Button>
                <RangeInput
                    :minIndex="0"
                    ...
                    class="pl-3 pr-3 fill-full-width"
                />
                <Button color="green" @click="$emit('inc-parameter', 'facialHair', 0, getFacialCount(), 1)">
                    <Icon :size="14" icon="icon-chevron-right"></Icon>
                </Button>
            </div>
            ...
            <div class="split split-full center">
                <Button color="green" @click="$emit('dec-parameter', 'facialHairColor1', 0, getColourCount(), 1)">
                    <Icon :size="14" icon="icon-chevron-left"></Icon>
                </Button>
                <RangeInput
                    :minIndex="0"
                    ...
                    class="pl-3 pr-3 fill-full-width"
                />
                <Button color="green" @click="$emit('inc-parameter', 'facialHairColor1', 0, getColourCount(), 1)">
                    <Icon :size="14" icon="icon-chevron-right"></Icon>
                </Button>
            </div>
            <!-- Eyebrow Opacity -->
            ...
            <div class="split split-full center">
                <Button color="green" @click="$emit('dec-parameter', 'facialHairOpacity', 0, 1, 0.1)">
                    <Icon :size="14" icon="icon-chevron-left"></Icon>
                </Button>
                <RangeInput
                    :minIndex="0"
                    ...
                    class="pl-3 pr-3 fill-full-width"
                />
                <Button color="green" @click="$emit('inc-parameter', 'facialHairOpacity', 0, 1, 0.1)">
                    <Icon :size="14" icon="icon-chevron-right"></Icon>
                </Button>
            </div>
        </Module>
        ...
        <Module :name="getLocale('LABEL_CHEST_HAIR')" class="mb-4" v-if="data.sex === 1">
            ...
            <div class="split split-full center">
                <Button color="green" @click="$emit('dec-parameter', 'chestHair', 0, getChestCount(), 1)">
                    <Icon :size="14" icon="icon-chevron-left"></Icon>
                </Button>
                <RangeInput
                    :minIndex="0"
                    ...
                    class="pl-3 pr-3 fill-full-width"
                />
                <Button color="green" @click="$emit('inc-parameter', 'chestHair', 0, getChestCount(), 1)">
                    <Icon :size="14" icon="icon-chevron-right"></Icon>
                </Button>
            </div>
            ...
            <div class="split split-full center">
                <Button color="green" @click="$emit('dec-parameter', 'chestHairColor1', 0, getColourCount(), 1)">
                    <Icon :size="14" icon="icon-chevron-left"></Icon>
                </Button>
                <RangeInput
                    :minIndex="0"
                    ...
                    class="pl-3 pr-3 fill-full-width"
                />
                <Button color="green" @click="$emit('inc-parameter', 'chestHairColor1', 0, getColourCount(), 1)">
                    <Icon :size="14" icon="icon-chevron-right"></Icon>
                </Button>
            </div>
            <!-- Chest Hair Opacity -->
            ...
            <div class="split split-full center">
                <Button color="green" @click="$emit('dec-parameter', 'chestHairOpacity', 0, 1, 0.1)">
                    <Icon :size="14" icon="icon-chevron-left"></Icon>
                </Button>
                <RangeInput
                    :minIndex="0"
                    ...
                    class="pl-3 pr-3 fill-full-width"
                />
                <Button color="green" @click="$emit('inc-parameter', 'chestHairOpacity', 0, 1, 0.1)">
                    <Icon :size="14" icon="icon-chevron-right"></Icon>
                </Button>
            </div>
        </Module>
