    ...
    <div class="wrapper stack">
        ...
        <Module :name="getLocale('LABEL_FATHER')" class="mb-4">
            ...
            <div class="stack space-between">
                ...
                <div class="split split-full center">
                    <Button color="green" @click="$emit('dec-parameter', 'faceFather', 0, 45, 1)">
                    ...
                    />
                    <Button color="green" @click="$emit('inc-parameter', 'faceFather', 0, 45, 1)">
                ...
                <div class="split split-full center">
                    <Button color="green" @click="$emit('dec-parameter', 'skinFather', 0, 45, 1)">
                        <Icon :size="14" icon="icon-chevron-left"></Icon>
                    </Button>
                    <RangeInput
                        :minIndex="0"
                        ...
                        class="fill-full-width"
                    />
                    <Button color="green" @click="$emit('inc-parameter', 'skinFather', 0, 45, 1)">
                        <Icon :size="14" icon="icon-chevron-right"></Icon>
                    </Button>
                </div>
            </div>
        ...
        <Module :name="getLocale('LABEL_MOTHER')" class="mb-4">
            ...
            <div class="stack space-between">
                ...
                <div class="split split-full center">
                    <Button color="green" @click="$emit('dec-parameter', 'faceMother', 0, 45, 1)">
                        <Icon :size="14" icon="icon-chevron-left"></Icon>
                    </Button>
                    <RangeInput
                        :minIndex="0"
                        ...
                        class="fill-full-width"
                    />
                    <Button color="green" @click="$emit('inc-parameter', 'faceMother', 0, 45, 1)">
                        <Icon :size="14" icon="icon-chevron-right"></Icon>
                    </Button>
                </div>
                <div class="overline grey--text text--darken-1 mb-4 mt-4 fill-full-width align-left">
                ...
                <div class="split split-full center">
                    <Button color="green" @click="$emit('dec-parameter', 'skinMother', 0, 45, 1)">
                        <Icon :size="14" icon="icon-chevron-left"></Icon>
                    </Button>
                    <RangeInput
                        :minIndex="0"
                        ...
                        class="fill-full-width"
                    />
                    <Button color="green" @click="$emit('inc-parameter', 'skinMother', 0, 45, 1)">
                        <Icon :size="14" icon="icon-chevron-right"></Icon>
                    </Button>
                </div>
            </div>
        ...
        <Module :name="getLocale('LABEL_FACEBLEND')" class="mb-4">
            ...
            <div class="split split-full center">
                <Button color="green" @click="$emit('dec-parameter', 'faceMix', 0, 1, 0.1)">
                    <Icon :size="14" icon="icon-chevron-left"></Icon>
                </Button>
                <RangeInput
                    :minIndex="0"
                ...
                />
                <Button color="green" @click="$emit('inc-parameter', 'faceMix', 0, 1, 0.1)">
                    <Icon :size="14" icon="icon-chevron-right"></Icon>
                </Button>
            </div>
        </Module>
        ...
        <Module :name="getLocale('LABEL_SKINBLEND')" class="mb-4">
            ...
            <div class="split split-full center">
                <Button color="green" @click="$emit('dec-parameter', 'skinMix', 0, 1, 0.1)">
                    <Icon :size="14" icon="icon-chevron-left"></Icon>
                </Button>
                <RangeInput
                    :minIndex="0"
                    ...
                    class="pl-3 pr-3 fill-full-width"
                />
                <Button color="green" @click="$emit('inc-parameter', 'skinMix', 0, 1, 0.1)">
                    <Icon :size="14" icon="icon-chevron-right"></Icon>
                </Button>
            </div>
        </Module>
        ...
        <Module :name="getLocale('LABEL_EYECOLOUR')" class="mb-4">
            ...
            <div class="split split-full center">
                <Button color="green" @click="$emit('dec-parameter', 'eyes', 0, locales.color.eyes.length - 1, 1)">
                    <Icon :size="14" icon="icon-chevron-left"></Icon>
                </Button>
                <RangeInput
                    :minIndex="0"
                    ...
                    class="pl-3 pr-3 fill-full-width"
                />
                <Button color="green" @click="$emit('inc-parameter', 'eyes', 0, locales.color.eyes.length - 1, 1)">
                    <Icon :size="14" icon="icon-chevron-right"></Icon>
                </Button>
            </div>
        </Module>
