        ...
        <template v-for="(option, i) in overlaysList" :key="i">
            <Module :name="getLocale(option.id).name" class="mb-4">
                ...
                <div class="split space-between">
                    <Button color="green" @click="(e) => decValueWrap(i, option.min, option.max, 1)">
                    ...
                    />
                    <Button color="green" @click="(e) => incValueWrap(i, option.min, option.max, 1)">
                ...
                <div class="split space-between">
                    <Button color="green" @click="(e) => decValueWrap(i, 0, 1, 0.1, true)">
                        <Icon :size="14" icon="icon-chevron-left"></Icon>
                    </Button>
                    <RangeInput
                        :minIndex="0"
                        ...
                        class="pl-3 pr-3 fill-full-width"
                    />
                    <Button color="green" @click="(e) => incValueWrap(i, 0, 1, 0.1, true)">
                        <Icon :size="14" icon="icon-chevron-right"></Icon>
                    </Button>
                </div>
            </Module>
