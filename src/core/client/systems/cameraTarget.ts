    ...
    static init() {
        ...
        alt.setInterval(() => {
            ...
            if (closestTarget && closestTarget.pos && closestTarget.scriptID !== 0) {
                ...
                if (temporaryLabel) {
                    drawText3D(temporaryLabel, new alt.Vector3(pos.x, pos.y, closestTarget.normalizedZ), 0.75, new alt.RGBA(255, 255, 255, 255));
                    return;
                }

                drawText3D(displayLabel, new alt.Vector3(pos.x, pos.y, closestTarget.normalizedZ), 0.75, new alt.RGBA(255, 255, 255, 255));
            }
        }, 0);
    }
