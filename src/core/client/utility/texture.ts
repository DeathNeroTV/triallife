...
export function drawTexture2D(dictionary: string, name: string, position: alt.IVector2, scale: number = 1, opacity: number = 255) {
    ...
    native.drawSprite(dictionary, name, position.x, position.y, width, height, 0, 255, 255, 255, opacity, false, undefined);
}
